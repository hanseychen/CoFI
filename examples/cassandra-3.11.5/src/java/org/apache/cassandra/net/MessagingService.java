...
public final class MessagingService implements MessagingServiceMBean
{
    ...
    {
        String sender = FBUtilities.getBroadcastAddress().toString();
        String receiver = to.toString();
        String msgType = message.verb.toString();
        if (!Client.beforeSend(sender, receiver, msgType)) {
            return;
        }
